...
#su -l vagrant -c 'ssh -o StrictHostKeyChecking=no -p 6666 admin@localhost get-job exam >> /vagrant/jenkins/export_job.xml'
...
#java -jar /home/vagrant/jenkins-cli.jar -s http://localhost:8080/ -http -auth "$j_user:$j_pass" get-job exam >> /vagrant/jenkins/export_job.xml